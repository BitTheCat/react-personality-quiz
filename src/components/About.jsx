export default function About() {
  return (
    <div>
      <h2>About</h2>
          <p>This is a quiz to determine which element you are based on completely random things.</p>
          <p>This site is a Codédex React Course Project</p>
          ...
          <ul>
            ...
            <li>Validation components props</li> 
          </ul>
    </div>
  );
}
